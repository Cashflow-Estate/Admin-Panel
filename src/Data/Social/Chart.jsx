import FollowerGenderImage from '../../assets/images/dashboard-5/follower.png';
...
export const SmallWidgetsChartOption = {
  series: [],
  options: {
    chart: {
      width: 125,
