...
import Logins from '../myPages/myAuth/Signin';
...
export const authRoutes = [
  ...
  { path: `${process.env.PUBLIC_URL}/reset-password`, Component: <ForgetPassword /> },
  { path: `${process.env.PUBLIC_URL}/forgot-password`, Component: <ResetPassword /> },
