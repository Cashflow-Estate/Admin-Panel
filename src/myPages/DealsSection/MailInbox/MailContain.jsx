...
import email1 from '../../../../src/assets/images/house.jpg';
import email2 from '../../../../src/assets/images/house.jpg';
import email3 from '../../../../src/assets/images/house.jpg';
                      ...
                      <Row>
                        <Col md='6 xl-100' sm='12'>
                          <Media className='align-items-center'>
                            <Image attrImage={{ className: 'me-3 rounded-circle img-50', src: `${email1}`, alt: '' }} />
                            <Media body>
                              <H6>
