        ...
        <CardBody>
          <div className='social-img-wrap'>
            <div className='social-img'>
              <Image attrImage={{ src: require(`../../assets/images/user/3.png`), alt: 'profile' }} />
            </div>
          ...
          <div className='social-details'>
            ...
            <SocialData email={user.email} MemberType={user.MemberType} PackageName={user.PackageName} totalPost={user.totalPost} follower={user.follower} following={user.following} />
          </div>
        </CardBody>
      </Card>
    </Col>
