...
const UserDetails = () => {
  ...
  const [visitedTabs, setVisitedTabs] = useState(() => {
    const storedTabs = localStorage.getItem("visitedTabs");
  ...
  useEffect(() => {
    ...
    window.addEventListener("keydown", handleBrowserBackButton);

    return () => {
      window.removeEventListener("keydown", handleBrowserBackButton);
    };
  }, [handleBack]);
