...
import { Card, CardBody, CardHeader, Form, FormGroup, Input, Label, Row, Col } from 'reactstrap'; // Added Col import
...
const MyProfileEdit = () => {
  ...
  return (
    <Fragment>
      <Row>
        <Col md={{ size: 8, offset: 2 }}> {/* Adjust width using Bootstrap grid classes */}
          <Card>
            <CardHeader>
              ...
              <Form>
                <Row className='mb-2'>
                  <div className='profile-title'>
                    <div className='media'>
                      <Image attrImage={{ className: 'img-70 m-0 rounded-circle', alt: '', src: `${require('../../../assets/images/user/1.jpg')}` }} />
